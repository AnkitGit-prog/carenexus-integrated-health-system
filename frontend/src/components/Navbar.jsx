...
const Navbar = () => {
  ...
  // const[token,setToken]=React.useState(true);  remove because it is a temporary use
  ...
  return (
    <div className="flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-300 relative">
      ...
      <div className="flex items-center gap-4">
            ...
            ? <div className='flex items-center gap-2 cursor-pointer relative group'>
              ...
              <div className='absolute top-0 right-0 pt-14 text-base font-medium text-gray-600 z-20 hidden group-hover:block'>
                <div className='min-w-48 bg-stone-100 rounded flex flex-col gap-4 p-4'>
                  {/* however kw liye server start karna imp hota hai*/}
                  <p onClick={() => navigate('my-profile')} className='hover:text-black cursor-pointer'>My Profile</p>
                  <p onClick={() => navigate('my-appointements')} className='hover:text-black cursor-pointer'>My Appointements</p>
        ...
        <div
          className={`fixed top-0 right-0 bottom-0 w-full z-20 bg-white md:hidden ${showMenu ? 'block' : 'hidden'
            }`}
        >
