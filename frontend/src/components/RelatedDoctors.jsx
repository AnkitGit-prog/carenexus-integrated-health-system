...
<div className='flex flex-col items-center gap-4 my-16 text-gray-800 md:mx-10'>
       ...
       <div className='w-full grid grid-cols-auto gap-4 pt-5 gap-y-6 px-3 sm:px-0'>
        ...
        {relDoc.slice(0,5).map((item, index) => (
            ...
            <div onClick ={()=> {navigate(`/appointment/${item._id}`);scroll(0,0)}} className='border border-blue-500 rounded-xl overflow-hidden cursor-pointer hover:translate-y-[-10px] transition-all duration -500 ' key={index}>
              ...
              <div className ='p-4'>  
                ...
                <div className ='flex items-center  gap-2 text-sm text-center text-green-500'>
                    ...
                    <p className ='w-2 h-2 bg-yellow-200 rounded-full'></p><p>Available</p>
