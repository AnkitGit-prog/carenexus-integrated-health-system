...
const MyProfile = () => {
  ...
  //const [userData ,setUserData]= useState ({
   // name: 'Dr.Ankit Devkar',
   // image:assets.profile_pic,
   // email:'atgt@gmail.com',
   // phone:'1  +4565  77 4 57  555 56',
   // address:{
   //   line1:" 57 Bandra mumbai",
   //   line2:'877 andheri road'
  //  },
    //gender:"Male",
    //dob:'2000-3-19'
 ...
 const { userData, setUserData,token,backendUrl,loadUserProfileData } = useContext(AppContext);
  ...
  const updateUserProfileData=async()=>{
    try{
     ...
     // make api call to upadte the user profile data
  ...
  <div className=' max-w-lg flex flex-col gap-2  text-sm'>
   {
    isEdit?<label htmlFor='image'>
          <div className='inline-block rekative cursor-pointer'>
<img 
  className='w-36 rounded opacity-75'
  src={image ? URL.createObjectURL(image) : (userData?.image ? userData.image :null)}
  alt=''
/>
